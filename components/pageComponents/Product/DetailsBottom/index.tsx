...
import { ProductDetailsBottomTabTitles } from "./TabTitles";

export const ProductDetailsBottom = () => {
    return (
        <div className={styles.tabsWrapper}>
            <ProductDetailsBottomTabTitles />
                                ...
                                <div className="col">
                                    ...
                                    <div className="review-content">
                                        <p>
                                            ...
                                            blanditiis laudantium iste amet. Cum
                                            non voluptate eos enim, ab cumque
                                            nam, modi, quas iure illum
